...
class TokenJoiner:
    def __init__(self, key, invitecode, token):
        ...
        self.client.headers["X-Fingerprint"] = self.client.get("https://discord.com/api/v9/experiments").json()["fingerprint"]
